...
#ifndef _TFT32_ADAFRUIT_ILI9341H_
#define _TFT32_ADAFRUIT_ILI9341H_
...
class TFT32_Adafruit_ILI9341 : public Adafruit_GFX {
    protected:

    public:
        TFT32_Adafruit_ILI9341(int8_t _CS, int8_t _DC, int8_t _MOSI, int8_t _SCLK, int8_t _RST = -1, int8_t _MISO = -1);
        TFT32_Adafruit_ILI9341(int8_t _CS, int8_t _DC, int8_t _RST = -1);
